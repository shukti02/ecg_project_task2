...
filtMatObj = matfile(strcat('filteredLeads2_short.mat'));
ecgFeat = matfile('ECGfeatures_2_short.mat', 'Writable', true);
...
%miss out something at the end of the signal('NPeaks',
%floor(length(signal)./200),)
